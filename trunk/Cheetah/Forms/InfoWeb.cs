...
{
    public partial class InfoWeb : Form
    {
        public InfoWeb()
        {
            InitializeComponent();
        ...
        private void InfoWeb_Load(object sender, EventArgs e)
        {
        ...
        private void InfoWeb_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        {
            pictureBox1.BackgroundImage = Cheetah.Properties.Resources.CloseHover;
        }

        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            pictureBox1.BackgroundImage = Cheetah.Properties.Resources.Closes;
        }
        ...
        private void lblnameweb_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                if (this.Width - BorderWidth > e.Location.X && e.Location.X > BorderWidth && e.Location.Y > BorderWidth)
        ...
        private void lblnameweb_Click(object sender, EventArgs e)
        {
