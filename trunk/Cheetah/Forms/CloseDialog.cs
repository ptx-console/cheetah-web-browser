...
namespace Cheetah
{
    public partial class CloseDialog : Form
    {
        ...
        public CloseDialog(string s)
        {
            InitializeComponent();
            lbldes.Text = "You have " + s +" tabs running. Are you sure you want to close Cheetah?";
        }

        private void CloseDialog_VisibleChanged(object sender, EventArgs e)
        {
            CBdontshow.Checked = Cheetah.Properties.Settings.Default.DontShowWarningBox;
        }
        ...
        private void CloseDialog_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        {
            Cheetah.Properties.Settings.Default.DontShowWarningBox = CBdontshow.Checked;
            Cheetah.Properties.Settings.Default.Save();
            ButtonSender = "OK";
