...
{
    public partial class AboutCheetah : Form
    {
        int TL;
        string ButtonSender;
        [DllImport("psapi.dll")]
        ...
        private void linkSurf_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Form1 f = FindFirstInstanceOfForm1();
            f.AddTab("praken.tk");
        }

        private void AboutCheetah_Load(object sender, EventArgs e)
        {
        ...
        private void AboutCheetah_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void linkGtlite_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Form1 f = FindFirstInstanceOfForm1();
            f.AddTab("gt-web-software.webs.com");
        }
        ...
        private void linkJoinUs_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            FindFirstInstanceOfForm1().AddTab("http://gt-web-software.webs.com/getinvolved.htm");
        }

        private void linkLicense_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            FindFirstInstanceOfForm1().AddTab(Application.StartupPath + @"\Sources\license.html");//("http://www.gnu.org/licenses/lgpl.html");
        }

        private void linkCredit_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            FindFirstInstanceOfForm1().AddTab(Application.StartupPath + @"\Sources\credit.html");
        }
    }
}
