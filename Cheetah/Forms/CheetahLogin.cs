...
{
    public partial class CheetahAuthentication : Form
    {
        ...
        #endregion
        Uri url;
        public CheetahAuthentication(Uri u)
        {
            url = u;
            InitializeComponent();
        }
        ...
        private void MetroDialog_Load(object sender, EventArgs e)
        {
            ...
            AuthenticationObject o;
            if (AuthenticationPasswords.HasData(url, out o) == true)
            {
                if (o != null)
                {
                    waterMarkTextBox1.Text = o.Username;
                    waterMarkTextBox2.Text = o.Password;
                    checkBox1.Checked = true;
                    linkLabel1.Visible = true;
                    Transition.run(this, "Height", 209, new TransitionType_EaseInEaseOut(600));
                }
                else
                    Transition.run(this, "Height", 178, new TransitionType_EaseInEaseOut(600));
            }
            MinimizeFootprint();
        }
        ...
        private void OKButton_Click(object sender, EventArgs e)
        {
            ...
            AuthenticationObject o;
            if (checkBox1.Checked && AuthenticationPasswords.HasData(url, out o) == false)
                AuthenticationPasswords.Add(waterMarkTextBox1.Text, waterMarkTextBox2.Text, url);
            else if (AuthenticationPasswords.HasData(url, out o) == false)
                AuthenticationPasswords.ReplaceDataForUrl(waterMarkTextBox1.Text, waterMarkTextBox2.Text, url);
        ...
        {
            AuthenticationObject o;
            if (!AuthenticationPasswords.HasData(url, out o))
                return;
            AuthenticationPasswords.Remove(o);
