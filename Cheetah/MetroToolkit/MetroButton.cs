...
namespace Cheetah.MetroToolkit
{
    public partial class MetroButton : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            this.CreateGraphics().DrawLine(Pens.Gold, 0, 0, Width, 0);
            this.CreateGraphics().DrawLine(Pens.Gold, 0, Height - 1, Width, Height - 1);
            this.CreateGraphics().DrawLine(Pens.Gold, 0, 0, 0, Height);
            this.CreateGraphics().DrawLine(Pens.Gold, Width - 1, 0, Width - 1, Height);
        ...
        {
            LinearGradientBrush G = new LinearGradientBrush(new Point(0, Width), new Point(0, Height), Color.Goldenrod, Color.Goldenrod);
            this.CreateGraphics().FillRectangle(G, ClientRectangle);
            this.CreateGraphics().DrawLine(Pens.Goldenrod, 0, 0, Width, 0);
            this.CreateGraphics().DrawLine(Pens.Goldenrod, 0, Height - 1, Width, Height - 1);
            this.CreateGraphics().DrawLine(Pens.Goldenrod, 0, 0, 0, Height);
            this.CreateGraphics().DrawLine(Pens.Goldenrod, Width - 1, 0, Width - 1, Height);
            SolidBrush TextPen = new SolidBrush(ForeColor);
            StringFormat stringFormat = new StringFormat
            {
                Alignment = StringAlignment.Center,
        ...
        {
            LinearGradientBrush G = new LinearGradientBrush(new Point(0, Width), new Point(0, Height), Color.Yellow, Color.Yellow);
            this.CreateGraphics().FillRectangle(G, ClientRectangle);
            this.CreateGraphics().DrawLine(Pens.Yellow, 0, 0, Width, 0);
            this.CreateGraphics().DrawLine(Pens.Yellow, 0, Height - 1, Width, Height - 1);
            this.CreateGraphics().DrawLine(Pens.Yellow, 0, 0, 0, Height);
            this.CreateGraphics().DrawLine(Pens.Yellow, Width - 1, 0, Width - 1, Height);
            SolidBrush TextPen = new SolidBrush(ForeColor);
            StringFormat stringFormat = new StringFormat
            {
                Alignment = StringAlignment.Center,
